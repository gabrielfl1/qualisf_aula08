...
public class UC01RegistraEmprestimoDeLivro {
	...
	@Test
	public void CT0701FB_quandoUsuarioNuloErro() {
		//cenario
		...
		try {
			...
			assertEquals("Dados invalido", e.getMessage());
		}
		
	}
	
	@Test
	public void CT0802FB_dataEmprestimoInvalidaErro() {
		//cenario
	...
	@Test
	public void CT0802FB_dataEmprestimoValidaErro() {
		//cenario
